	...
	options: {
		...
		endless_scrolling : {
			endless_scrolling:  { defaultVal: true, showInOptions: true, dispText: "Endless scrolling sur les pages compatibles", sub_options: {
				...
				snatched:    { defaultVal: true, showInOptions: true, dispText: "Mes Snatched", tooltip: "/my.php?snatched" },
				logs:        { defaultVal: true, showInOptions: true, dispText: "Logs", tooltip: "/logs.php" },
				req:         { defaultVal: true, showInOptions: true, dispText: "Requests", tooltip: "/req.php" },
				uploads:     { defaultVal: true, showInOptions: true, dispText: "Mes Uploads", tooltip: "/my.php?uploads" },
				series:      { defaultVal: true, showInOptions: true, dispText: "Mes Séries", tooltip: "/series.php" },
			} },
